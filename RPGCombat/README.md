...
# Personal Notes
- Certain I could improve this with another pass.
- Command pattern might be worth looking into for entity / character actions.
- Character class was probably too big by the end of this.
- Overall I feel like implementation was successful, albeit a bit messy.
- I think I could have done a better job of separating concerns.